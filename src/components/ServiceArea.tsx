      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-8">
              {areas.map((area, index) => (
                <div key={index} className="flex items-center space-x-2">
                  <CheckCircle className="w-4 sm:w-5 h-4 sm:h-5 text-orange-600 flex-shrink-0" />
            ...
            <div className="bg-blue-900 text-white p-5 sm:p-6 rounded-xl">
              <div className="flex items-start space-x-3">
                <MapPin className="w-5 sm:w-6 h-5 sm:h-6 text-orange-500 flex-shrink-0 mt-1" />
                <div>
                  <p className="font-semibold mb-2 text-sm sm:text-base">Not sure if we cover your area?</p>
          ...
          <div className="relative hidden lg:block">
            <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 border-4 border-orange-500">
